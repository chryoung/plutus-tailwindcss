...
Plutus is a mobile-friendly web front-end client for [beancount](https://beancount.github.io/).
...
* [`src/cljs/plutus_tailwindcss/`](src/cljs/plutus_tailwindcss/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/plutus_tailwindcss/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/plutus_tailwindcss/`](test/cljs/plutus_tailwindcss/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `plutus-tailwindcss` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/plutus_tailwindcss/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns plutus-tailwindcss.example
  (:require [plutus-tailwindcss.config :as config])
